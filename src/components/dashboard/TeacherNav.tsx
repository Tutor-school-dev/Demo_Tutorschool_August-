...
import { User, LogOut, ChevronDown, LayoutDashboard, FileText, Users, UserCircle, Zap } from "lucide-react";
...
export default function TeacherNav() {
  ...
  const teacherName = typeof window !== "undefined" ? localStorage.getItem("name") || "Teacher" : "Teacher";
